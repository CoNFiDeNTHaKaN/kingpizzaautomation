<?php
	...
	$request = 'http://webservices.vebra.com/export/BORLANDBAPI/v9/branch/23358/property/'.$property;

	if ( empty($_GET['property']) ) {
		$GLOBALS['request'] = "http://webservices.vebra.com/export/BORLANDBAPI/v9/branch/23358/property";	
	}
	
	function getToken() {
		$file = "headers/log_" . date('Y-m-d_H-i-s', time() ) . '.txt' ;
		$fh = fopen($file, "w");
